...
### model assessment when sample size decreases
...
### Random subsampling liver dataset: 25, 20, 15, 10
### Repeat subsamping for 5 times
...
for (z in 1:length(sublib)) {
    ...
    for (k in 1:length(seedlib)) {
        ...
        ### Step 2: Bayesian Method analysis
